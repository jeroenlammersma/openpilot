...
CONFIGS = [
  ProcessConfig(
    ...
    pub_sub={
      ...
      "modelV2": [], "driverCameraState": [], "roadCameraState": [], "wideRoadCameraState": [], "managerState": [], "testJoystick": [], "drivingCoachState": [],
    },
    ...
    submaster_config={
      ...
      'ignore_alive': ['wideRoadCameraState', 'drivingCoachState'],  # TODO: Add to regen
    }
  ),
  ProcessConfig(
    proc_name="radard",
