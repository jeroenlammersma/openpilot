...
procs = [
  ...
  NativeProcess("dmonitoringmodeld", "selfdrive/modeld", ["./dmonitoringmodeld"], enabled=True, callback=driverview),
  ...
  PythonProcess("dmonitoringd", "selfdrive.monitoring.dmonitoringd", enabled=True, callback=driverview),
