...
from selfdrive.coachd.modules.tailgating_detection import TailgatingStatus, is_tailgating
from selfdrive.coachd.modules.tailgating_detection import MINIMAL_VELOCITY, THW_THRESHOLD
